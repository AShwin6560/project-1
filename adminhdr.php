...
<body>
	...
	<header class="clearfix">
			<a href="adminhome.php" style="color: #000;"><h1>Vechile Rental & Booking System</h1></a>
			<p>Welcome Admin <b ><?php echo $_SESSION['username']; ?></b>! <a href="admins.php"><button style="padding: 8px 12px;">Profile</button></a> <a href="adminlogout.php"><button>Logout</button></a></p>
	</header>
