...
<?php
	...
	if(isset($_POST['register'])){
		...
		if(!isset($_POST['nic']) || strlen(trim($_POST['nic'])) < 1 ){
			$errors[]= 'ctznship no. is missing or invalid';
		}else{
			...
			if($result_set01){
				...
				if(mysqli_num_rows($result_set01) == 1){
					//valid user found
					$dualaccounterrors[] = 'There Is An Accout With This ctznship no. Already';
				}
...
<html>
<head>
	<title> VECHILE RENTAL & BOOKING SYSTEM | Register</title>
...
<body>
	...
	<?php require_once('inc/hdr.php'); ?>
		...
		<div class="Blank">
			...
			<div class="RegForm">
				<h1>REGISTER TO VECHILE RENTAL & BOOKING SYSTEM</h1>
			</div><!--RegForm-->
				...
				<form action="reg.php" method="post">
						...
						if(isset($errors) && !empty($errors)){
								...
								echo '<p class="error">There Is An Accout With This Email, ctznshp no. or Phone Number Already</p>';
						}
						...
						<h2 class="Topic">Citizenship No.</h2>
