...
<html>
<head>
	<title>Vehicle Rental & Booking System | Login</title>
</head>
	...
	<?php require_once('inc/hdr.php'); ?>
		...
		<div class="Main">
			...
			<div class="LogForm clearfix">
				<h1>LOGIN TO VEHICLE RENTAL & BOOKING SYSTEM</h1>
			</div><!--LogForm-->
				...
				<form action="login.php" method="post">
					<div>
						...
						<h2></h2>
						<input class="RePassword" type="password" placeholder="Re-type your Password" name="repassword"><br>
					...
					<div class="Down">
						<ul>
							...
							<li><a href="reg.php">Don't have an account yet?</a></li>
						</ul>
					</div>
