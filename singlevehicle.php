...
<body>
	...
	<div class="Singlevehicle">
		<h1>#<?php echo $data['post_id']; ?> <?php echo $data['brand_name']; ?> ~ <?php echo $data['vehical_name']; ?> <?php echo $data['mnf_year']; ?></h1>
			...
			<?php
				...
				if(isset($errors) && empty($errors) && $booked == 'true'){
					...
					?><p class="success">Youy have successfully booked this vehicicle. <br>A notification will be sent to your Eastern Vehicle Book & Rent account after the booking is confirmed by Admins.</p><?php
		...
		<br><br>
			...
			<h3 class="bookpreh3"><?php echo $data['price']; ?> NPR</h3>
			<?php
				if(isset($_SESSION['user_id'])){
			...
			<form action="singlevehicle.php?post_id=<?php echo($post_id); ?>" method="post">
				...
				<p>
					<h3 class="bookh3" name="bookh3" id="bookh3" style="display: none;"><?php echo $data['price']; ?> NPR</h3>
