...
<html>
<head>
	<title>Eastern Vehicle Book & Rent</title>
	...
	<?php require_once('inc/hdr.php'); ?>
			...
			<div class="Cont">
				<div class="Content3 clearfix">
						...
						<div class="Advice">
							<h2>Get great deals on a Vehicle rental and save big</h2>
							<h5>Trying to find the best vehicle rental deal?</h5>
							<p>There is no need to look further – you can always find a special offer and save big on Eastern Vehicle Book & Rent!<br><br>Cooperating with hundreds of global and local vehicle rental suppliers, we provide a wide choice of vehicles of all classes and find the perfect vehicle for your journey. Eastern Vehicle Book & Rent is ready to assist you whatever your question is and wherever you are in Nepal.</p>
						</div><!-- Advice -->

						<div class="Hotline">
							<h2>Hot-Line:</h2>
							<h1><i class="fas fa-phone-alt"></i></h1>
							<h3>+977 XXX XXX XX XX</h3>
							<h6>Call Center Working Hours</h6>
							<h6>Sun – Fri: 8:00 AM — 10:00 PM GMT</h6>
							<h6>Sat: 8:00 AM — 9:00 PM GMT</h6>
						</div><!-- Hotline -->
