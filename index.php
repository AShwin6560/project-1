...
<html>
<head>
	<title>Vechile Rental & Booking System</title>
...
<body>
	<?php require_once('inc/hdr.php'); ?>
		...
		<header>
			...
			<div class="Header">
				...
				<div class="Header-Col2">
					...
					<div class="Text">
						<h1>Vechile Rental & Booking System</h1>
					</div><!--Text-->
					<br>

					<div class="Paragraph">
						<p>Welcome to Vechile Rental & Booking System, your number one source for all <br>type of Vehicle Renting and Vehicle Booking. </p>
					</div><!--Paragraph-->
		...
		<div class="First">
			...
			<div class="button2">
				<a href="rntacr.php"><button>RENT A VEHICLE</button></a>
			</div>
			<div class="button3">	
				<a href="shwrm.php"><button>BOOK A VEHICLE</button></a>
			</div>
			...
			<div class="AboutUs">
				...
				<div class="ParaAboutUs">
					...
					Welcome to Vechile Rental & Booking System, your number one source for all type of Vehicle Renting and Vehicle Booking. We're dedicated to giving you the very best of Vehicle Renting & Booking facilities, with a focus on Fair price rates, Comfortable ride, Your protection & Safety, and Responsible service..........
							...
							$i = 0;
								while ($data = mysqli_fetch_assoc($result)) {
									if($i<8){
										...
										?><div class="Item">
											<img src="web_img/<?php echo($kind); ?>/<?php echo($data['kind_of_vehicle']); ?>/<?php echo($data['post_id']); ?>/<?php echo($data['front_side_img']); ?>" alt="Vehicle photo here">
											...
											<h3 style="color: yellow"><?php echo $data['price']; ?> /=<br><span style="color: #808080;">NPR per day</span></h3>
		...
		<div class="Asc">
			<div class="Desc">
				<div class="Upper">
					<p>A big thank you to Vechile Rental & Booking System for the beyond satisfactory help with my trip planning and airport drop and pick up! The moment I landed in TIA I was greeted with smiles – Nepal the nation that forever smiles. I visited Nepal with my fiance and we were transported to beautiful Biratnagar, a slow but comfortable drive. We loved every part of our trip and it’s all thanks to Eastern Vehicle Book & Rent for organising everything and total ease of mind!</p>
				</div><!-- Upper -->
			</div><!-- Desc -->
		</div><!-- Asc -->
		...
		<div class="Lastdiv">
			...
			<p>Vechile Rental & Booking System can assist the non resident renter, who does not have a Nepali driving licence, to obtain a temporary license from the Department of Transport Management Nepal for the duration of stay in Nepal. This is a legal requirement and mandatory to drive a vehicle in Nepal. Apart from the government fee, no other charges will be levied for this service. Baby seats also will be provided free of charge for the duration of the rental period.</p>
		</div><!-- Lastdiv -->
